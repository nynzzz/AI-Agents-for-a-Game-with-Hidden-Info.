...
public class LSTMnISMCTSPlayer implements Player{
    ...
    public LSTMnISMCTSPlayer(String color, int iterationLimit, double EXPL) {
        this.color = color;
    ...
    public void makeMove(Board board) {
        ...
        LSTMISMCTS ismcts = new LSTMISMCTS(currentState, iterationLimit, EXPL);
