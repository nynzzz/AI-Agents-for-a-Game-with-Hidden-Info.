...
import sneakthrough.AI.AlphaISMCTS.AlphaISMCTS;
import sneakthrough.AI.AlphaISMCTS.Node_AlphaISMCTS;
...
public class AlphaISMCTSPlayer implements Player {
    ...
    public AlphaISMCTSPlayer(String color, int iterationLimit, double EXPL) {
        this.color = color;
    ...
    public void makeMove(Board board) {
        ...
        AlphaISMCTS A0ismcts = new AlphaISMCTS(currentState, iterationLimit, EXPL);

        // best child node
        Node_AlphaISMCTS bestChild = A0ismcts.runAlphaISMCTS();

//        System.out.println("best child visits: " + bestChild.getVisits());
//        System.out.println("best child policy: " + bestChild.getPolicy());
//        System.out.println("best child move: " + bestChild.printMoveToStringFlattened());
