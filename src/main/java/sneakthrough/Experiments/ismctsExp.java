...
//        runExperiment();
        ...
        CSVWriter writer = new CSVWriter(new FileWriter("src/main/resources/Experiments/alpha_ismctsExp/a0_vs_ismcts.csv"));

        int numOfRuns = 5;

//        // numOfRuns with ismcts white vs random black
//        Player white = new ISMCTSPlayer("white", 1000, 0.7);
        Player white = new AlphaISMCTSPlayer("white", 100, 100);
//        Player black = new RandomPlayer("black");

        // numOfRuns with ismcts black vs random white
//        Player white = new RandomPlayer("white");
        Player black = new ISMCTSPlayer("black", 100, 0.7);
